                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="quan_tri_khoa.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Quản trị khoa
                            </a>
                        </div>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                        ...
                                        $thong_tin_sinh_vien = mysqli_query($ket_noi, $sql);

                                        // 4. Hiển thị ra dữ liệu mà các bạn vừa lấy được
                                        $i=0;
                                        while ($row = mysqli_fetch_array($thong_tin_sinh_vien)) 
                                        {
                                            $i++;
                                    ;?>
                                        <tr>
                                            <td style="text-align: center;"><?php echo $row["ma_sv"];?></td>
                                            <td><?php echo $row["ten_sv"];?></td>
                                            <td><?php echo $row["dia_chi"];?></td>
                                            <td><?php echo $row["sdt"];?></td>
                                            <td style="text-align: center;"><a href="sinh_vien_sua.php?id=<?php echo $row['ma_sv'];?>">Sửa</a></td>
                                            <td style="text-align: center;"><a href="sinh_vien_xoa.php?id=<?php echo $row['ma_sv'];?>">Xóa</a></td>
                                        </tr>                                        
                                        <?php 
                                        }
