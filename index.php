...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            $noi_dung_sinh_vien = mysqli_query($ket_noi, $sql1);
            $noi_dung_lop = mysqli_query($ket_noi, $sql2);

            // 4. Đếm số lượng bản ghi cần thống kê
            $so_luong_sinh_vien = mysqli_num_rows($noi_dung_sinh_vien);
            $so_luong_lop = mysqli_num_rows($noi_dung_lop);
            ;?>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Quản trị sinh viên (<?php echo $so_luong_sinh_vien;?> sinh viên)</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="quan_tri_sinh_vien.php">Chi tiết</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Quản trị lớp (<?php echo $so_luong_lop;?> khoa)</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="quan_tri_lop.php">Chi tiết</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>                       
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Trần Việt Hải</div>
                        </div>
                    </div>
                </footer>
            </div>
